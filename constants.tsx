...
const BlogIcon = (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <path d="M16.535 7.465S16.535 7.465 16.535 7.465c-.2-.191-.499-.181-.699.021-.19.2-.182.499.021.699l.009.008.006-.006c.19-.201.18-.501-.021-.699-.199-.202-.498-.212-.699-.022h0L12 11.292l-1.516-1.516c-.199-.199-.512-.199-.707 0s-.199.512 0 .707L11.293 12l-2.001 2.001c-.199.199-.199.512 0 .707s.512.199.707 0L12 12.707l3.535-3.535c.2-.2.2-.512.001-.707zM7 15h5v2H7zm0-4h2v2H7zm0-4h2v2H7z"></path>
    </svg>
);
...
export const ORGANIZATION_INFO: OrganizationInfo = {
  ...
  longName: "HERE AND NOW AI – Artificial Intelligence Research Institute", // Corrected typo
  ...
  socialLinks: [
    ...
    { name: "X", url: "https://x.com/hereandnow_ai", icon: TwitterIcon },
